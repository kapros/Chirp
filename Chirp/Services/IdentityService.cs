    ...
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> LoginAsync(string email, string password)
        {
            ...
            if (!userHasValidPassword)
                return new AuthenticationResult { Errors = new[] { "User / password combination is incorrect" } };
        ...
        public async Task<AuthenticationResult> RegisterAsync(string email, string password)
        {
            ...
            return await GenerateAuthenticationTokenAsync(newUser);
        }

        private async Task<AuthenticationResult> GenerateAuthenticationTokenAsync(IdentityUser user)
        {
            var tokenHandler = new JwtSecurityTokenHandler();
